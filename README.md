...
- **主机型号管理**：添加/上下架型号，分配服务器，设置型号级购买限量
...
所有建表语句在 [install/index.php](file:///d:/yun/26-5-6/install/index.php#L36-L200) 中集中管理，新增字段或表可在该文件中维护。老用户升级请运行 [upgrade.php](file:///d:/yun/26-5-6/upgrade.php)。
